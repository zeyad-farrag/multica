...
func (h *Handler) GetIssue(w http.ResponseWriter, r *http.Request) {
	...
	total, err := h.Queries.ComputeIssueEstimateRollup(r.Context(), db.ComputeIssueEstimateRollupParams{
		IssueID:     issue.ID,
		WorkspaceID: issue.WorkspaceID,
	})
	if err != nil {
		slog.Warn("compute issue estimate rollup failed", append(logger.RequestAttrs(r), "error", err, "issue_id", id)...)
	} else {
		resp.ComputedEstimateMinutes = total
	}
...
func (h *Handler) UpdateIssue(w http.ResponseWriter, r *http.Request) {
	...
	params := db.UpdateIssueParams{
		...
		EstimateMinutes: prevIssue.EstimateMinutes,
	}
